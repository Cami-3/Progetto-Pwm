...
<body
	...
	<div class="container">
		<div id="regLogin"
			...
			<div>
				<s:form action="ModificaProdotto" method="post" theme="simple">
								<s:hidden name="p2.idprodotto" value="%{pM.idprodotto}"/>
					...
					<div>
						<label> Taglia: </label>
						<s:textfield type="number" name="p2.taglia" value="%{pM.taglia}"></s:textfield>
					</div>
					...
					<div>
						<label> Quantità: </label>
						<s:textfield type="number" name="p2.quantita" value="%{pM.quantita}"/>
					</div>
<br>
