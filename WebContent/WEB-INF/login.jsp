...
<body
	...
	<div class="container">
		...
		<s:form action="Login" method="post"
			style="margin-left: -41px;margin-top: -65px;" theme="simple">
			...
			<div id="regLogin"
				...
				<div class="containerLogin" style="width: 50%; margin-top: 27px;">
					...
					<s:fielderror
						style="color:red ; margin-left: 100px; margin-top: 27px;"
						fieldName="email" />
<br><br>
					<label for="password" class="labelLogin"> <b>Password</b>
					</label>
					...
					<div style="text-align: left">
						...
						<s:fielderror
							style="color:red ; margin-left: 50px; margin-top: 15px;"
							fieldName="password" />
