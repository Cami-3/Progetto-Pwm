	...
	<div class="container">
		...
		<div class="container-fluid" id="container-wrapper">
			...
			<table>
				<tr>
					<td style="font-size: 18px; color: black">Nome:&nbsp &nbsp<s:property
							value="titolare.nome" /></td>
				</tr>
				<tr>
					<td style="font-size: 18px; color: black">Cognome:&nbsp &nbsp
						<s:property value="titolare.cognome" />
					</td>
				...
				<tr>
					<td style="font-size: 18px; color: black">Codice Fiscale:&nbsp
						&nbsp<s:property value="titolare.CF" />
					</td>
			...
			<div class="form-group">
				...
				<a href="VisualizzaOrdini"><button
						style="background-color: black; border-color: black; color: white">Visualizza
						Ordini</button></a> <a href="richiediAggiungiProdotto"><button
						style="background-color: black; border-color: black; color: white">Aggiungi
						un prodotto</button></a> <a href="VisualizzaProdotti"><button
						style="background-color: black; border-color: black; color: white">Visualizza
						prodotti</button></a> <a href="richiediAggiungiCliente"><button
						style="background-color: black; border-color: black; color: white">Aggiungi
						Cliente</button></a> <a href="VisualizzaClienti"><button
						style="background-color: black; border-color: black; color: white">Visualizza
						Clienti</button></a>
